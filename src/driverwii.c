...
//	DRIVER( tetrist )	/* C12 (c) 1989 Sega Enterprises,Ltd. (Japan) */ /* FIXME */
...
/* FIXME : 30 May, 2018 - Midway games broken! Error when compiling the core with Retroarch and DevkitPPC 29.1 */
#ifdef coreC
...
#if 0
	DRIVER( battlane )	/* -0215, -0216 (Data East part number) (c) 1986 + Taito license */ // FIXME : undefined reference to tilemap 
